...
[![GitHub License](https://img.shields.io/github/license/F1-SQL/f1-sql-database?style=for-the-badge&labelColor=%23333&color=%23d40000)](LICENSE)
[![GitHub Stars](https://img.shields.io/github/stars/F1-SQL/f1-sql-database?style=for-the-badge&labelColor=%23333&color=%23d40000)](https://github.com/F1-SQL/f1-sql-database/stargazers)
...
in the [f1-sql repository](https://github.com/F1-SQL/f1-sql).
...
The core build consumes this repository at an exact Git commit. Every database
release records that commit and the schema version in its build manifest.
Schema changes are released only with a matching, tested core loader.
...
schema repository. They are distributed by the core project under the data
